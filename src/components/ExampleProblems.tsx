...
const EXAMPLE_PROBLEMS: ExampleProblem[] = [
  ...
  // === 新增模板 ===
  {
    ...
    icon: "💥",
    category: "dynamics",
    physicsType: "2d_collision",
    analysis: {
      ocrText: "两球质量m1=2kg, m2=3kg，m1以v1=5m/s撞击静止的m2，碰撞后m2偏转30°。",
      concepts: ["二维碰撞", "动量守恒", "恢复系数"],
      knownValues: { m1: 2, m2: 3, v1: 5, theta: 30, e: 1 },
      forces: ["碰撞力"],
      physicsType: "2d_collision",
      description: "二维碰撞：动量守恒+可调恢复系数，展示碰后偏转",
    },
  },
  {
    title: "滚动与滑移",
    icon: "🎳",
    category: "dynamics",
    physicsType: "rolling_slipping",
    analysis: {
      ocrText: "保龄球以v0=8m/s水平抛出，半径R=0.5m，摩擦系数μ=0.3，求何时开始纯滚动。",
      concepts: ["滚动", "滑移", "摩擦力矩", "转动"],
      knownValues: { v0: 8, mu: 0.3, R: 0.5, g: 9.8 },
      forces: ["摩擦力", "重力", "支持力"],
      physicsType: "rolling_slipping",
      description: "保龄球从滑动到纯滚动：摩擦力减速平动同时加速转动",
    },
  },
  {
    title: "物理摆（复摆）",
    icon: "📏",
    category: "dynamics",
    physicsType: "physical_pendulum",
    analysis: {
      ocrText: "均匀杆长L=2m，一端固定为轴，从θ₀=45°释放，求摆动周期。",
      concepts: ["物理摆", "转动惯量", "力矩"],
      knownValues: { L: 2, theta0: 45, g: 9.8 },
      forces: ["重力", "轴力"],
      physicsType: "physical_pendulum",
      description: "均匀杆绕端点摆动：I=mL²/3，ω₀=√(3g/2L)",
    },
  },
  {
    title: "大角度单摆",
    icon: "📐",
    category: "oscillations",
    physicsType: "large_angle_pendulum",
    analysis: {
      ocrText: "单摆摆长L=2m，初始角度θ₀=120°释放，求运动轨迹。",
      concepts: ["大角度摆", "非线性", "傅里叶展开"],
      knownValues: { L: 2, theta0: 120, g: 9.8 },
      forces: ["重力", "绳张力"],
      physicsType: "large_angle_pendulum",
      description: "大角度单摆：对比真实运动与小角度近似，展示非线性差异",
    },
  },
  {
    title: "堆叠球（超级球）",
    icon: "🏐",
    category: "dynamics",
    physicsType: "stacked_ball",
    analysis: {
      ocrText: "两个球堆叠，从h=2m高度自由下落，求上面小球反弹的最大高度。",
      concepts: ["动量传递", "碰撞", "超级球效应"],
      knownValues: { h: 2, g: 9.8 },
      forces: ["重力", "碰撞力"],
      physicsType: "stacked_ball",
      description: "堆叠球下落：动量传递使顶球弹至9倍下落高度",
    },
  },
  {
    title: "LC振荡电路",
    icon: "⚡",
    category: "em",
    physicsType: "lc_circuit",
    analysis: {
      ocrText: "LC电路中电容C=1F，电感L=1H，初始电荷Q₀=5C，求振荡频率和能量。",
      concepts: ["LC振荡", "电磁能量转换", "谐振"],
      knownValues: { C: 1, L: 1, Q0: 5 },
      forces: [],
      physicsType: "lc_circuit",
      description: "LC电路：电荷和电流的简谐振荡，电场能与磁场能相互转换",
    },
  },
  {
    title: "法拉第电磁感应",
    icon: "🧲",
    category: "em",
    physicsType: "faraday_law",
    analysis: {
      ocrText: "矩形线圈宽w=2m，以v=2m/s进入磁场B=1T区域，电阻R=5Ω，求感应电动势。",
      concepts: ["法拉第定律", "电磁感应", "楞次定律"],
      knownValues: { B: 1, v: 2, R: 5, w: 2 },
      forces: ["安培力"],
      physicsType: "faraday_law",
      description: "线圈穿越磁场区域：进入/离开时产生感应电动势",
    },
  },
  {
    title: "电容器充放电",
    icon: "🔋",
    category: "em",
    physicsType: "capacitor",
    analysis: {
      ocrText: "RC电路中电源V=10V，电阻R=5Ω，电容C=1F，求充电过程电压变化。",
      concepts: ["RC电路", "充电", "时间常数"],
      knownValues: { V: 10, R: 5, C: 1 },
      forces: [],
      physicsType: "capacitor",
      description: "RC充电：Vc=V(1-e^(-t/RC))，τ=RC为时间常数",
    },
  },
  {
    title: "质量落上弹簧",
    icon: "🔴",
    category: "oscillations",
    physicsType: "mass_spring_drop",
    analysis: {
      ocrText: "质量m=1kg从h=2m高处自由下落至劲度系数k=20N/m的弹簧上，求振动。",
      concepts: ["自由落体", "弹簧简谐运动", "能量守恒"],
      knownValues: { m: 1, k: 20, h: 2, g: 9.8 },
      forces: ["重力", "弹力"],
      physicsType: "mass_spring_drop",
      description: "物体落上弹簧：先自由落体，接触弹簧后做简谐运动",
    },
  },
];
