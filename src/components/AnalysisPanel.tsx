  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border space-y-4">
      ...
      {analysis.concepts && analysis.concepts.length > 0 && (
        <div>
          <h3 className="text-sm font-medium text-gray-800 mb-1">💡 物理概念</h3>
      ...
      {analysis.knownValues && Object.keys(analysis.knownValues).length > 0 && (
        <div>
          <h3 className="text-sm font-medium text-gray-800 mb-1">📊 已知量</h3>
          <div className="flex flex-wrap gap-2">
      ...
      {analysis.forces && analysis.forces.length > 0 && (
        <div>
          <h3 className="text-sm font-medium text-gray-800 mb-1">→ 受力分析</h3>
          <div className="flex flex-wrap gap-2">
      ...
      {analysis.description && (
        <div>
          <h3 className="text-sm font-medium text-gray-800 mb-1">📖 场景描述</h3>
