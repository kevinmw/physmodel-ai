...

{
  ...
  "forces": ["受力分析"],
  "physicsType": "projectile_motion | pendulum | spring | inclined_plane | circular_motion | free_fall | vertical_throw | horizontal_throw | elastic_collision | magnetic_field | wave_superposition | energy_conservation | damped_oscillation | uniform_acceleration | binary_star | electric_deflection | forced_oscillation | lissajous | other",
